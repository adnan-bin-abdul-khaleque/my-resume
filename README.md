...
Welcome to my Data Analytics project portfolio. This repository showcases applied analytics work across business intelligence, data cleaning, exploratory analysis, and predictive modeling. The projects demonstrate end-to-end workflows including data preparation, visualization, and forecasting using industry-standard tools.
...
- Implemented and evaluated multiple forecasting models  
- Assessed model performance using MAE and RMSE metrics  
- Generated analytical insights for sustainable energy planning  
- Documented findings as a conference research paper  

### Skills Demonstrated
Predictive Modeling • Time-Series Analysis • Research Analytics • Python
...
- Interactive filters by product and location  
...
## 🗄 Project 3: Layoffs Data Analysis  
**Tools:** SQL

### Overview
A data cleaning and exploratory data analysis project using a real-world layoffs dataset.

### Key Contributions
- Cleaned and standardized raw data  
- Performed SQL-based transformation and querying  
- Identified trends across industries and time periods  
- Generated analytical summaries and insights  

### Skills Demonstrated
SQL • Data Cleaning • Exploratory Data Analysis • Data Transformation
...
Data Analytics Enthusiast focused on transforming data into actionable insights through visualization, modeling, and analytical storytelling.
